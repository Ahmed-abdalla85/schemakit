(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../utils/json-helpers"], factory);
    }
    ...
    class SchemaLoader {
        ...
        async loadEntityDefinition(entityName) {
            ...
            if (entity.metadata && typeof entity.metadata === 'string') {
                entity.metadata = (0, json_helpers_1.safeJsonParse)(entity.metadata, {});
            }
            return entity;
        }
        /**
        ...
        async loadEntityFields(entityId) {
            ...
            for (const field of fields) {
                if (field.metadata && typeof field.metadata === 'string') {
                    field.metadata = (0, json_helpers_1.safeJsonParse)(field.metadata, {});
                }
                if (field.validation_rules && typeof field.validation_rules === 'string') {
                    field.validation_rules = (0, json_helpers_1.safeJsonParse)(field.validation_rules, {});
                }
            }
            return fields;
        }
        ...
        async loadEntityPermissions(entityId, context) {
            ...
            for (const permission of permissions) {
                if (permission.conditions && typeof permission.conditions === 'string') {
                    permission.conditions = (0, json_helpers_1.safeJsonParse)(permission.conditions, {});
                }
            }
            return permissions;
        }
        ...
        async loadEntityViews(entityId) {
            ...
            for (const view of views) {
                if (view.query_config && typeof view.query_config === 'string') {
                    view.query_config = (0, json_helpers_1.safeJsonParse)(view.query_config, {});
                }
            }
            return views;
        }
        ...
        async loadEntityWorkflows(entityId) {
            ...
            for (const workflow of workflows) {
                ...
                if (workflow.conditions && typeof workflow.conditions === 'string') {
                    workflow.conditions = (0, json_helpers_1.safeJsonParse)(workflow.conditions, {});
                }
                if (workflow.actions && typeof workflow.actions === 'string') {
                    workflow.actions = (0, json_helpers_1.safeJsonParse)(workflow.actions, []);
                }
            }
            return workflows;
        }
        ...
        async loadEntityRLS(entityId, context) {
            ...
            for (const rule of rlsRules) {
                if (rule.rls_config && typeof rule.rls_config === 'string') {
                    rule.rls_config = (0, json_helpers_1.safeJsonParse)(rule.rls_config, {
