(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../errors", "./validation-manager", "./permission-manager"], factory);
    }
    ...
    class QueryManager {
        constructor(databaseAdapter) {
            ...
            this.permissionManager = new permission_manager_1.PermissionManager(databaseAdapter);
        }
        /**
         * Execute view query
        ...
        async executeView(entityConfig, viewName, params = {}, context = {}) {
            try {
                ...
                if (!view) {
                    throw new errors_1.SchemaKitError(`View '${viewName}' not found for entity '${entityConfig.entity.name}'`);
                }
                ...
                throw new errors_1.SchemaKitError(`Failed to execute view '${viewName}' for entity '${entityConfig.entity.name}': ${error}`);
            }
        }
        /**
        ...
        async executeCustomQuery(entityConfig, queryBuilder, context = {}) {
            try {
                ...
                throw new errors_1.SchemaKitError(`Failed to execute custom query for entity '${entityConfig.entity.name}': ${error}`);
            }
        }
        /**
