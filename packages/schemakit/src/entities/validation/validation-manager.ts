...
export class ValidationManager {
  ...
  private validateField(
    ...
    if (fieldConfig.field_is_required && (operation === 'create' || allData.hasOwnProperty(fieldConfig.field_name))) {
      if (value === undefined || value === null || value === '') {
        errors.push({
          field: fieldConfig.field_name,
          code: 'required',
          message: `Field '${fieldConfig.field_name}' is required`,
          value
        });
    ...
    if (fieldConfig.field_validation_rules) {
